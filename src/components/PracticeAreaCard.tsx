...
export function PracticeAreaCard({ area }: { area: PracticeArea }) {
  return (
    <div id={area.slug} className="group bg-white border border-line scroll-mt-28">
      ...
      <div className="p-6">
        ...
        <Link
          ...
          className="mt-5 flex w-full items-center justify-center bg-navy px-5 py-2.5 text-xs font-semibold uppercase tracking-wide text-white transition-colors hover:bg-gold hover:text-navy-deep"
        >
          Learn More
        </Link>
      </div>
